...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="mainNav">
    ...
    <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav navbar-sidenav" id="exampleAccordion">
            ...
            <!--Order Customer-->
             <li class="nav-item" data-toggle="tooltip" data-placement="right" title="OrderCustomer">
                <a class="nav-link nav-link-collapse collapsed" data-toggle="collapse" href="#collapseOrderCustomer" data-parent="#exampleAccordion">
                    <i class="fa fa-fw fa-wrench"></i>
                    <span class="nav-link-text">Order customer</span>
                </a>
                <ul class="sidenav-second-level collapse" id="collapseOrderCustomer">
                    <li>
                        <a href="/RestaurantManagement/order-list">Order list</a>
                    </li>
                     <li>
                        <a href="/RestaurantManagement/new-order">New order</a>
                    </li>
                </ul>
            </li>
